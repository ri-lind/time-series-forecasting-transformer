...
\begin{itemize}
    \item \textbf{RQ2.1:} Which model performs best across all forecasting horizons?
    \item \textbf{RQ2.2:} Which model performs best for each specific forecasting horizon?
\end{itemize}
