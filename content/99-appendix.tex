...
\hline
Model & RMSE  & MASE & MAE & MAPE & R2 Score & Median AE \\
\hline
SAMFormer   & 0.4065 & 2.7328 & 0.3308 & 1.1723 & 0.7928 & 0.2906 \\
...
Model & MAE & RMSE & MASE \\
\hline
LinearRegression                & 0.2947 & 0.3673 & 2.1171 \\
RandomForestRegressor           & 0.3228 & 0.4099 & 2.3192 \\
ExtraTreesRegressor             & 0.3098 & 0.3980 & 2.2252 \\
MLPRegressor                    & 0.3615 & 0.4488 & 2.5972 \\
Linear SVR                      & 0.4013 & 0.4954 & 2.8825 \\
HistGradientBoostingRegressor   & 0.3875 & 0.4817 & 2.7840 \\
\hline
\end{tabular}
...
\begin{tabular}{lccccccc}
\hline
Model & RMSE & MASE & MAE & MAPE & R2 Score & Median AE & MSE \\
\hline
SAMFormer   & 0.4754 & 2.9686 & 0.3773 & 1.1654 & 0.7056 & 0.3090 & --     \\
TimesFM     & 0.4410 & --     & 0.3514 & 1.3885 & 0.6432 & --     & --     \\
TimeGPT     & 0.4390 & --     & 0.3312 & 1.6603 & -0.3999& --     & 0.1927 \\
...
Model & MAE & RMSE & MASE \\
\hline
LinearRegression                & 0.2989 & 0.3767 & 2.1572 \\
RandomForestRegressor           & 0.3167 & 0.3881 & 2.2862 \\
ExtraTreesRegressor             & 0.3122 & 0.3824 & 2.2534 \\
MLPRegressor                    & 0.3519 & 0.4358 & 2.5402 \\
Linear SVR                      & 0.3869 & 0.4745 & 2.7925 \\
HistGradientBoostingRegressor   & 0.3564 & 0.4507 & 2.5725 \\
\hline
\end{tabular}
...
\hline
Model & RMSE & MASE & MAE & MAPE & R2 Score & Extra \\
\hline
SAMFormer   & 0.4058 & 2.7328 & 0.3308 & 1.1723 & 0.7928  & -- \\
...
\begin{tabular}{lccc}
\hline
\textbf{Model} & \textbf{MAE} & \textbf{RMSE} & \textbf{MASE} \\
\hline
LinearRegression              & 0.4098 & 0.5097 & 2.9819 \\
RandomForestRegressor         & 0.2948 & 0.3619 & 2.1447 \\
ExtraTreesRegressor           & 0.2889 & 0.3565 & 2.1016 \\
MLPRegressor                  & 0.3660 & 0.4531 & 2.6630 \\
Linear SVR                    & 0.4189 & 0.5136 & 3.0481 \\
HistGradientBoostingRegressor & 0.4038 & 0.5158 & 2.9380 \\
\hline
\end{tabular}
...
\begin{tabular}{lcccccc}
\hline
Model & RMSE (manual) & MASE & MAE & MAPE & R2 Score & Median AE \\
\hline
SAMFormer   & 1.2537 & 4.5419 & 0.8397 & 0.07415 & 0.9830 & 0.5705 \\
...
\textbf{Model} & \textbf{MAE} & \textbf{RMSE} & \textbf{MASE} \\
\hline
LinearRegression              & 0.1253 & 0.1738 & 23.1186 \\
RandomForestRegressor         & 1.2835 & 1.6653 & 236.8282 \\
ExtraTreesRegressor           & 1.2869 & 1.6682 & 237.4575 \\
MLPRegressor                  & 1.0366 & 1.5134 & 191.2762 \\
Linear SVR                    & 0.1520 & 0.2083 & 28.0553 \\
HistGradientBoostingRegressor & 1.3442 & 1.7122 & 248.0257 \\
\hline
\end{tabular}
...
Model & RMSE (manual) & MASE & MAE & MAPE & R2 Score & Median AE \\
\hline
SAMFormer   & 1.7918 & 6.6621 & 1.2279 & 0.10377 & 0.9638 & 0.8517 \\
...
\textbf{Model} & \textbf{MAE} & \textbf{RMSE} & \textbf{MASE} \\
\hline
LinearRegression              & 0.2089 & 0.2849 & 38.5451 \\
RandomForestRegressor         & 1.3105 & 1.6671 & 241.8076 \\
ExtraTreesRegressor           & 1.3038 & 1.6618 & 240.5773 \\
MLPRegressor                  & 1.1546 & 1.6571 & 213.0487 \\
Linear SVR                    & 0.2444 & 0.3315 & 45.1031 \\
HistGradientBoostingRegressor & 1.3361 & 1.6863 & 246.5396 \\
\hline
\end{tabular}
...
Model & RMSE (manual) & MASE & MAE & MAPE & R2 Score & Median AE \\
\hline
SAMFormer   & 2.4161 & 9.0428 & 1.6667 & 0.13844 & 0.9288 & 1.1651 \\
...
\textbf{Model} & \textbf{MAE} & \textbf{RMSE} & \textbf{MASE} \\
\hline
LinearRegression              & 0.3486 & 0.4572 & 64.1587 \\
RandomForestRegressor         & 1.3564 & 1.6762 & 249.6495 \\
ExtraTreesRegressor           & 1.3494 & 1.6702 & 248.3699 \\
MLPRegressor                  & 1.1109 & 1.5923 & 204.4707 \\
Linear SVR                    & 0.3652 & 0.4795 & 67.2108 \\
HistGradientBoostingRegressor & 1.3756 & 1.6902 & 253.1865 \\
\hline
\end{tabular}
...
\begin{tabular}{lcccccc}
\hline
\textbf{Model} & \textbf{RMSE (sklearn)} & \textbf{MASE} & \textbf{MAE} & \textbf{MAPE} & \textbf{R2 Score} & \textbf{Median AE} \\
\hline
SAMFormer   & 0.54167 & 1.26679 & 0.30328 & 0.64230 & 0.64452 & 0.11782 \\
...
\textbf{Model} & \textbf{MAE} & \textbf{RMSE} & \textbf{MASE} \\
\hline
LinearRegression              & 0.5014 & 0.6978 & 1.7673 \\
RandomForestRegressor         & 0.3157 & 0.5860 & 1.1129 \\
ExtraTreesRegressor           & 0.3050 & 0.5598 & 1.0752 \\
MLPRegressor                  & 0.3933 & 0.5936 & 1.3862 \\
Linear SVR                    & 0.7456 & 0.9987 & 2.6280 \\
HistGradientBoostingRegressor & 0.4549 & 0.6248 & 1.6033 \\
\hline
\end{tabular}
...
\textbf{Model} & \textbf{RMSE (sklearn)} & \textbf{MASE} & \textbf{MAE} & \textbf{MAPE} & \textbf{R2 Score} & \textbf{Median AE} \\
\hline
SAMFormer   & 0.54040 & 1.24772 & 0.29871 & 0.63941 & 0.64619 & 0.11680 \\
...
\textbf{Model} & \textbf{MAE} & \textbf{RMSE} & \textbf{MASE} \\
\hline
LinearRegression              & 0.4136 & 0.6287 & 1.4595 \\
RandomForestRegressor         & 0.2914 & 0.5545 & 1.0284 \\
ExtraTreesRegressor           & 0.2848 & 0.5456 & 1.0051 \\
MLPRegressor                  & 0.3599 & 0.5581 & 1.2700 \\
Linear SVR                    & 0.6760 & 0.9015 & 2.3853 \\
HistGradientBoostingRegressor & 0.4134 & 0.5901 & 1.4588 \\
\hline
\end{tabular}
...
\textbf{Model} & \textbf{RMSE (sklearn)} & \textbf{MASE} & \textbf{MAE} & \textbf{MAPE} & \textbf{R2 Score} & \textbf{Median AE} \\
\hline
SAMFormer   & 0.54043 & 1.24991 & 0.29924 & 0.64137 & 0.64613 & 0.11268 \\
...
\textbf{Model} & \textbf{MAE} & \textbf{RMSE} & \textbf{MASE} \\
\hline
LinearRegression              & 0.3273 & 0.5551 & 1.1547 \\
RandomForestRegressor         & 0.2948 & 0.5647 & 1.0400 \\
ExtraTreesRegressor           & 0.2880 & 0.5616 & 1.0160 \\
MLPRegressor                  & 0.3656 & 0.5747 & 1.2896 \\
Linear SVR                    & 0.5653 & 0.7760 & 1.9942 \\
HistGradientBoostingRegressor & 0.4036 & 0.5942 & 1.4237 \\
\hline
\end{tabular}
...
\begin{tabular}{lcccccc}
\hline
\textbf{Model} & \textbf{RMSE} & \textbf{MASE} & \textbf{MAE} & \textbf{MAPE} & \textbf{R2 Score} & \textbf{Median AE} \\
\hline
SAMFormer & 1.0920 & 24.4912 & 0.7214 & 8.7253 & -1.2159 & 0.4679 \\
...
\textbf{Model} & \textbf{MAE} & \textbf{RMSE} & \textbf{MASE} \\
\hline
LinearRegression              & 0.7121 & 1.0847 & 48.5616 \\
RandomForestRegressor         & 1.8881 & 2.0738 & 128.7552 \\
ExtraTreesRegressor           & 1.6375 & 1.7732 & 111.6607 \\
MLPRegressor                  & 1.0811 & 1.5152 & 73.7188 \\
Linear SVR                    & 0.9266 & 1.4208 & 63.1832 \\
HistGradientBoostingRegressor & 1.1408 & 1.2652 & 77.7935 \\
\hline
\end{tabular}
...
\textbf{Model} & \textbf{RMSE} & \textbf{MASE} & \textbf{MAE} & \textbf{MAPE} & \textbf{R2 Score} & \textbf{Median AE} \\
\hline
SAMFormer & 2.3210 & 63.20795 & 1.78826 & 20.97415 & -16.42980 & 1.49668 \\
...
\textbf{Model} & \textbf{MAE} & \textbf{RMSE} & \textbf{MASE} \\
\hline
LinearRegression              & 2.3868 & 3.1923 & 164.0767 \\
RandomForestRegressor         & 1.9649 & 2.1291 & 135.0758 \\
ExtraTreesRegressor           & 1.8989 & 2.0403 & 130.5420 \\
MLPRegressor                  & 0.7829 & 1.0326 & 53.8228 \\
Linear SVR                    & 2.1916 & 3.0589 & 150.6586 \\
HistGradientBoostingRegressor & 1.3243 & 1.4157 & 91.0412 \\
\hline
\end{tabular}
...
\textbf{Model} & \textbf{RMSE} & \textbf{MASE} & \textbf{MAE} & \textbf{MAPE} & \textbf{R2 Score} & \textbf{Median AE} \\
\hline
SAMFormer & 8.45283 & 251.18168 & 7.05131 & 99.87629 & -316.1960 & 7.31353 \\
...
\textbf{Model} & \textbf{MAE} & \textbf{RMSE} & \textbf{MASE} \\
\hline
LinearRegression              & 16.4885 & 18.8402 & 991.2257 \\
RandomForestRegressor         & 1.6899  & 1.8402  & 101.5923 \\
ExtraTreesRegressor           & 1.1521  & 1.2634  & 69.2597 \\
MLPRegressor                  & 0.8744  & 1.0400  & 52.5646 \\
Linear SVR                    & 9.1181  & 10.7121 & 548.1414 \\
HistGradientBoostingRegressor & 0.7875  & 0.8774  & 47.3437 \\
\hline
\end{tabular}
